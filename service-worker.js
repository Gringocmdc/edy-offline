const CACHE='edy-offline-v0.4';
const FILES=['./','./index.html','./manifest.webmanifest','./css/styles.css','./js/storage.js','./js/calculator.js','./js/app.js','./data/manuals.json','./icons/icon.svg'];
