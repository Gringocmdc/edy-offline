const CACHE='edy-offline-v1.0-beta';
const FILES=['./','./index.html','./manifest.webmanifest','./styles.css','./storage.js','./calculator.js','./app.js','./manuals.json','./inventory.json','./zones.json','./icon.svg'];
